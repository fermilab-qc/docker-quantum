...
RUN source activate && LC_ALL=en_US.UTF-8 pip install \
	openfermion==0.8.1 cirq==0.3.1.35 openfermionpyscf==0.3 openfermionpsi4==0.4
...
#RUN source activate && pip install --upgrade git+https://github.com/quantumlib/cirq@c1e8e5f
